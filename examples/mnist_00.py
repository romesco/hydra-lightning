...
def cli_main(cfg):
    ...
    val_loader = hydra.utils.instantiate(cfg.dataloader, dataset=mnist_val, _recursive_=False)
    test_loader = hydra.utils.instantiate(cfg.dataloader, dataset=mnist_test, _recursive_=False) 
