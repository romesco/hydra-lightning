...
def cli_main(cfg):
    ...
    # training
    # ------------
    # NOTE: Here we use `hydra.utils.instantiate(cfg.trainer)` because the trainer conf is an autogenerated hydra-lightning config. This is additionally useful because it support recursive instnantiation (for example adding `Callback`s).
